...
export default function Home({ upcomingEvents = [] }: { upcomingEvents?: any[] }) {
    ...
    const dbMappedEvents = (upcomingEvents || []).map((event: any) => {
    ...
    return (
        <WelcomeLayout>
            ...
            {/* 1. Hero Section */}
            <section className="relative w-full overflow-hidden bg-gradient-to-b from-blue-50/20 via-transparent to-transparent dark:from-blue-950/5 dark:via-transparent dark:to-transparent">
                <div className="max-w-[1200px] mx-auto px-6 pt-16 pb-20 md:py-24 grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 flex items-center justify-center relative w-full pt-6 lg:pt-0">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-blue-500/10 dark:bg-blue-600/5 rounded-full blur-[80px] -z-10" />

                        {/* Main Mockup container */}
                        <div className="w-full max-w-[540px] rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#0E121E] shadow-2xl flex overflow-hidden aspect-[4/3] relative z-10 select-none">
                            
                            {/* Mock sidebar */}
                            <div className="w-[125px] bg-[#FAFBFD] dark:bg-[#090D15] border-r border-slate-100 dark:border-slate-800/60 p-3 flex flex-col gap-5 text-left shrink-0">
                            ...
                            <div className="flex-1 p-4 space-y-4.5 flex flex-col bg-white dark:bg-[#0E121E] overflow-hidden">
                                ...
                                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/60 pb-2.5">
                                    <div className="flex items-center gap-2 w-full max-w-[220px] bg-slate-50 dark:bg-[#111625] border border-slate-100 dark:border-slate-800 rounded-lg px-2.5 py-1 text-slate-400">
            ...
            {/* 2. Stats Block Row */}
            <section className="max-w-[1200px] mx-auto px-6 py-6 pb-14">
            ...
            <section id="event-mendatang" className="max-w-[1200px] mx-auto px-6 py-12 pb-16 space-y-8 scroll-mt-20">
                    ...
                    {featuredEvents.map((event, index) => (
                        ...
                        >
                            ...
                            <div className="h-44 w-full bg-slate-100 dark:bg-slate-800 relative overflow-hidden shrink-0">
                                ...
                                <div className="absolute top-3 left-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm rounded-lg px-2.5 py-1 text-center flex flex-col justify-center min-w-[54px]">
            ...
            {/* 4. Features Section */}
            <section className="max-w-[1200px] mx-auto px-6 py-12 pb-16 space-y-12">
            ...
            <section id="cara-kerja" className="max-w-[1200px] mx-auto px-6 py-12 pb-16 space-y-12 scroll-mt-20">
            ...
            <section id="kolaborasi-pilihan" className="max-w-[1200px] mx-auto px-6 py-12 pb-16 space-y-8 scroll-mt-20">
                <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 text-left">
            ...
            <section className="max-w-[1200px] mx-auto px-6 py-10 pb-20">
                <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 dark:from-blue-900 dark:via-blue-950 dark:to-blue-900 text-white p-8 md:p-14 lg:p-16 shadow-2xl flex flex-col lg:flex-row items-center gap-10 lg:gap-14 text-left">
                    ...
                    {/* Right image column */}
                    <div className="flex-1 w-full max-w-[420px] relative z-10 shrink-0 select-none">
