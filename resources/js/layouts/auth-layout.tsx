...
export default function AuthLayout({ children, title, description }: { children: React.ReactNode; title: string; description: string }) {
    return (
        <div className="relative min-h-screen grid lg:grid-cols-2 bg-[#F8F9FB] dark:bg-[#090D1A] transition-colors duration-300">
            ...
            <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden bg-linear-to-br from-[#0A0E1A] via-[#11182D] to-[#0D1324] border-r border-slate-800/60 select-none">
                {/* Glow Nodes */}
                ...
                <div className="relative z-10 my-auto max-w-lg space-y-10">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-4xl font-extrabold tracking-tight text-white leading-tight">
                            ...
                            <span className="bg-linear-to-r from-indigo-400 via-sky-400 to-indigo-300 bg-clip-text text-transparent">Kolaborasi Bersama Tim</span>,<br />
                    ...
                    <div className="backdrop-blur-md bg-white/3 border border-white/8 rounded-2xl p-6 shadow-2xl space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex gap-3 items-start p-2 rounded-lg hover:bg-white/2 transition-colors">
            ...
            <div className="flex items-center justify-center p-6 md:p-12 relative overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-100 h-100 rounded-full bg-indigo-500/5 dark:bg-indigo-500/3 blur-[80px] pointer-events-none" />
                ...
                <div className="w-full max-w-115 relative z-10">
                    ...
                    {/* Elegant Form Card */}
                    <div className="bg-white dark:bg-[#111625]/90 border border-gray-200/80 dark:border-slate-800/80 rounded-3xl shadow-xl shadow-gray-100/50 dark:shadow-none p-8 sm:p-10 transition-all duration-300">
